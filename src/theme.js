...
export const tokens = (mode) => ({
  ...(mode === "dark"
    ? {
        ...
        // Green accent leaning towards water blue
        greenAccent: {
          100: "#dbf5ee",
          200: "#b7ebde",
          300: "#94e2cd",
    ...
    : {
        //Light Mode
        //ctrl + p then type > then descending invert the dark mode color codes from descending
        grey: {
          100: "#141414",
          200: "#292929",
          300: "#3d3d3d",
...
// mui theme settings : change color modes dark and light
